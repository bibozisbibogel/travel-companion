...
class EnhancedWorkflowStateManager:
    ...
    def __init__(
        self, 
        workflow_id: str, 
        config: Optional[WorkflowPersistenceConfig] = None,
        ...
        self.index_key = f"workflow:index"  # Global workflow index
    ...
    async def resume_workflow(self, snapshot_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def _restore_from_enhanced_snapshot(self, snapshot_id: str) -> Optional[TripPlanningWorkflowState]:
