...
class TestAuthLogger:
    ...
    def test_log_registration_success(self, logger):
        ...
        logger.log_registration_success(
            user_id=user_id, email="test@example.com", ip_address="192.168.1.1"
        )
    ...
    def test_log_login_attempt(self, logger):
        ...
        logger.log_login_attempt(email="test@example.com", ip_address="192.168.1.1")
    ...
    def test_log_token_generated(self, logger):
        ...
        user_id = uuid4()
        logger.log_token_generated(user_id=user_id, ip_address="192.168.1.1", expires_in_minutes=30)
    ...
    def test_log_token_validated(self, logger):
        ...
        logger.log_token_validated(
            user_id=user_id, ip_address="192.168.1.1", endpoint="/api/v1/users/me"
        )
    ...
    def test_log_token_expired(self, logger):
        ...
        logger.log_token_expired(ip_address="192.168.1.1", endpoint="/api/v1/users/me")
    ...
    def test_log_token_invalid(self, logger):
        ...
        logger.log_token_invalid(
            ip_address="192.168.1.1", endpoint="/api/v1/users/me", reason="Malformed signature"
        )
    ...
    def test_log_token_missing(self, logger):
        ...
        logger.log_token_missing(ip_address="192.168.1.1", endpoint="/api/v1/users/me")
    ...
    def test_log_profile_accessed(self, logger):
        ...
        user_id = uuid4()
        logger.log_profile_accessed(user_id=user_id, ip_address="192.168.1.1")
