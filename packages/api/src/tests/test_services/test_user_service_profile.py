...
class TestUserServiceProfileUpdate:
    ...
    async def test_update_user_success_all_fields(
        self, user_service, mock_client, sample_user_id, sample_user_data
    ):
        ...
        update_data = UserUpdate(
            first_name="Jane", last_name="Smith", travel_preferences=new_preferences
        )
    ...
    async def test_update_user_success_partial_fields(
        self, user_service, mock_client, sample_user_id, sample_user_data
    ):
    ...
    async def test_update_user_success_only_preferences(
        self, user_service, mock_client, sample_user_id, sample_user_data
    ):
    ...
    async def test_update_user_preferences_validation(
        self, user_service, mock_client, sample_user_id, sample_user_data
    ):
