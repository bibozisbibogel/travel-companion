...
class TestWeatherAgent:
    ...
    @pytest.mark.asyncio
    async def test_process_weather_request_success(self, weather_agent, sample_weather_request, sample_weather_forecast):
        """Test successful weather request processing."""
        # Mock the OpenWeatherMap client
        with patch.object(weather_agent.openweather_client, 'get_weather_forecast', return_value=sample_weather_forecast) as mock_forecast:
    ...
    async def test_process_weather_request_api_failure(self, weather_agent, sample_weather_request):
        ...
        # Mock API failure
        with patch.object(weather_agent.openweather_client, 'get_weather_forecast', side_effect=Exception("API Error")):
    ...
    @pytest.mark.asyncio
    async def test_process_weather_request_with_historical(self, weather_agent, sample_weather_request, sample_weather_forecast):
        """Test weather request processing with historical data."""
        # Mock both forecast and historical data
        with patch.object(weather_agent.openweather_client, 'get_weather_forecast', return_value=sample_weather_forecast) as mock_forecast:
            with patch.object(weather_agent.openweather_client, 'get_historical_weather', return_value=[
                WeatherData(
    ...
    @pytest.mark.asyncio
    async def test_weather_caching(self, weather_agent, sample_weather_request, sample_weather_forecast):
        """Test weather response caching."""
        # Mock the API client
        with patch.object(weather_agent.openweather_client, 'get_weather_forecast', return_value=sample_weather_forecast) as mock_forecast:
            with patch.object(weather_agent.cache_manager, 'get_weather_cache', return_value=None) as mock_get_cache:
                with patch.object(weather_agent.cache_manager, 'set_weather_cache', return_value=True) as mock_set_cache:
    ...
    async def test_weather_cache_hit(self, weather_agent, sample_weather_request):
        ...
        with patch.object(weather_agent.cache_manager, 'get_weather_cache', return_value=cached_response) as mock_get_cache:
            with patch.object(weather_agent.openweather_client, 'get_weather_forecast') as mock_forecast:
    ...
    @pytest.mark.asyncio
    async def test_get_activity_recommendations_specific_types(self, weather_agent, sample_weather_data):
    ...
    def test_calculate_activity_suitability_outdoor(self, weather_agent):
        ...
        score, factors = weather_agent._calculate_activity_suitability("outdoor_sightseeing", good_weather)
    ...
    def test_calculate_activity_suitability_indoor(self, weather_agent):
        ...
        score, factors = weather_agent._calculate_activity_suitability("museums_indoor", rainy_weather)
    ...
    def test_calculate_activity_suitability_beach(self, weather_agent):
        ...
        score, factors = weather_agent._calculate_activity_suitability("beach_activities", perfect_beach_weather)
